...
\lstinputlisting[language=Java, firstnumber=6]{./Quellcode/DuplicateUserException.java}
\begin{center}
    \begin{small}
...
\clearpage
\lstinputlisting[language=Java, firstnumber=86]{./Quellcode/Main1.java}
\begin{center}
    \begin{small}
...
\lstinputlisting[language=Java, firstnumber=105]{./Quellcode/Main2.java}
\begin{center}
    \begin{small}
...
\lstinputlisting[language=Java, firstnumber=69]{./Quellcode/UserStore1.java}
\begin{center}
    \begin{small}
...
\lstinputlisting[language=Java, firstnumber=66]{./Quellcode/UserStore2.java}
\begin{center}
    \begin{small}
...
\lstinputlisting[language=Java, firstnumber=37]{./Quellcode/Eventlogger1.java}
\begin{center}
    \begin{small}
