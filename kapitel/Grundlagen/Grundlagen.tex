...
Eigene Exceptions werden normalerweise durch Vererbung realisiert. Dabei differenziert man zwischen Exceptions (checked) und RuntimeExceptions (unchecked). Die verwendete Variante hängt von der Art des Fehlerzustands ab. Ist der Zustand vorhersehbar und sinnvoll behandelbar, sind checked Exceptions geeignet.
